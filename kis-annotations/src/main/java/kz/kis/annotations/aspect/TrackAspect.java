package kz.kis.annotations.aspect;

import kz.kis.annotations.constant.*;
...
import static kz.kis.annotations.utils.AspectUtils.*;

@Aspect
@Component
public class TrackAspect {

    private final static Logger LOGGER = LoggerFactory.getLogger("kis.track");

    @Around("@annotation(kz.kis.annotations.annotation.Track)")
