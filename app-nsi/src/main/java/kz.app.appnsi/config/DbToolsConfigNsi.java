...
@Configuration
public class DbToolsConfigNsi {

    private static final Logger log = LoggerFactory.getLogger(DbToolsConfigNsi.class);
    ...
    @Bean(name = "dbNsi")
    public Db db(@Qualifier("dataSourceNsi") DataSource dataSource, SqlParamInterceptor sqlParamInterceptor) {
    ...
    public DataSource dataSource() {
        log.info("=========================");
        log.info("DbToolsConfigNsi.dataSource");
        log.info("url: " + dbUrl);
